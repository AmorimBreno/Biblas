...
class UsuarioSingleton {
  ...
  late List<LivroUsuario> livros = [
    LivroUsuario(repositorio.livros[0], DateTime.utc(2022, 2, 04), DateTime.utc(2022, 2, 11), LivroSituacao.EMPOSSE),
    LivroUsuario(repositorio.livros[1], DateTime.utc(2022, 2, 05), DateTime.utc(2022, 2, 12), LivroSituacao.DEVOLVIDO),
    LivroUsuario(repositorio.livros[2], DateTime.utc(2022, 2, 06), DateTime.utc(2022, 2, 13), LivroSituacao.ATRASADO),
  ];
